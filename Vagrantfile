...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    apt-get update
    apt-get --yes dist-upgrade aptitude
    ...
    ln -sf /var/www/html/vagrant-config/000-default.conf /etc/apache2/sites-available/000-default.conf
    sudo service apache2 restart
    mysql -uroot -ppassword -e "GRANT ALL PRIVILEGES ON drupal8.* TO 'drupal8'@'localhost' IDENTIFIED BY 'drupal8';"
  SHELL
end
